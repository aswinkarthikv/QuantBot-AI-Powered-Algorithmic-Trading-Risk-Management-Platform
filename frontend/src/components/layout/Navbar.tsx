...
import { Bell, User as UserIcon, Activity, PlusCircle } from 'lucide-react';
      ...
      <div className="flex items-center gap-3">
        {onOpenTradeModal && (
          <button
            ...
            className="flex items-center gap-2 bg-gradient-to-r from-quant-green to-emerald-600 hover:from-emerald-500 hover:to-emerald-700 text-slate-950 text-xs font-bold px-3.5 py-2 rounded-lg shadow-lg shadow-emerald-500/20 transition transform hover:-translate-y-0.5"
          >
